...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ScanTaskResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/nuclei/scan": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "Return compact summary (default: true). Set to false for full results",
                        "name": "compact",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ScanTask"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/nuclei/scan/async/{taskId}/result": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Return compact summary (default: true)",
                        "name": "compact",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "handler.ScanTask": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/handler.TaskStatus"
                },
                "target": {
                    "type": "string"
                },
        ...
        "models.Schedule": {
            ...
            "properties": {
                ...
                "decision": {
                    "description": "true = continue to dynamic analysis",
                    "type": "boolean"
                },
                "id": {
                    "type": "string"
                ...
                "tool": {
                    "description": "comma-separated tools: nmap, zap, openvas, etc.",
                    "type": "string",
                    "example": "nmap,zap,openvas"
                },
                "updated_at": {
                    "type": "string"
                },
