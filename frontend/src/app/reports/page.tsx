          ...
          <div className="mt-auto">
            <div className="p-5 rounded-2xl bg-gradient-to-br from-blue-600/10 to-cyan-600/10 dark:from-blue-500/20 dark:to-cyan-500/20 border border-blue-200 dark:border-blue-500/30">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 mb-4 font-medium">
                Your license expires in 14 days.
              </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-lg font-medium">
                  Create detailed compliance documents and security summaries
                      ...
                      <label className="flex items-center gap-3 cursor-pointer group">
                        <div className="relative inline-flex items-center">
                          <input
                            ...
                            onChange={(e) =>
                              setShowRemediationSteps(e.target.checked)
                            }
                            className="sr-only peer"
                            type="checkbox"
                          />
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1 w-full">
                      <div className="flex justify-between text-sm">
                        <span className="text-[#637588] dark:text-[#92a4c9]">
                          Passing
                        </span>
