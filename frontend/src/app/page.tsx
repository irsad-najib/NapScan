...
export default function Home() {
  ...
  const vulnerabilities = [
    {
      ...
      cvssScore: 7.2,
      description:
        "The application does not properly sanitize user input in the login form, allowing attackers to inject malicious scripts.",
      evidence:
        "Input field 'username' reflects unsanitized user input: <script>alert('xss')</script>",
      remediation:
    ...
    },
    {
      ...
      cvssScore: 5.3,
      description:
        "The application uses an outdated version of Lodash library with known vulnerabilities.",
      evidence:
        "Lodash version 4.17.15 detected in node_modules. Current version: 4.17.21",
      remediation:
        "Update Lodash to version 4.17.21 or later: npm install lodash@latest",
    },
    {
      id: 3,
      severity: "Low",
      ...
      cvssScore: 2.1,
      description:
        "Images on the landing page are missing alternative text attributes required for accessibility.",
      evidence: '<img src="hero.png" /> - No alt attribute found',
      remediation:
        'Add descriptive alt text to all images: <img src="hero.png" alt="Hero banner" />',
    },
    {
      id: 4,
      severity: "High",
      ...
      cvssScore: 8.6,
      description:
        "The query endpoint concatenates user input directly into SQL queries without parameterization.",
    ...
    },
    {
      ...
      cvssScore: 5.4,
      description:
        "The application fails to properly validate user access controls, allowing users to view other users' profiles by manipulating the user ID parameter.",
      evidence:
        "Accessing /profile/view?id=2 while logged in as user 1 displays user 2's sensitive information.",
      remediation:
        "Implement proper authorization checks to verify the user owns or has permission to access the requested resource before returning data.",
    },
  ];
  ...
  const stats = [
    ...
    },
    {
      ...
      trendUp: false,
      icon: "bug_report",
      bgColor: "bg-gradient-to-br from-orange-600 to-orange-400",
          ...
          <div className="max-w-7xl mx-auto flex flex-col gap-8 pb-20">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-base font-medium">
                Monitor and manage identified vulnerabilities across your
                infrastructure
              </p>
            </div>
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-6 border-b border-slate-200 dark:border-slate-700">
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm mt-1">
                    Manage and remediate security risks across your assets
                  </p>
                </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-700/30">
                      <th className="px-6 py-4 text-left font-semibold text-slate-700 dark:text-slate-300 uppercase text-xs tracking-wider">
                        ID
                      </th>
                      <th className="px-6 py-4 text-left font-semibold text-slate-700 dark:text-slate-300 uppercase text-xs tracking-wider">
                        Asset
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="relative">
                              <button
                                onClick={() =>
                                  setOpenActionMenu(
                                    openActionMenu === vuln.id ? null : vuln.id
                                  )
                                }
                                ...
                                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg z-10">
                                  ...
                                  <button
                                    onClick={() => {
                                      if (
                                        confirm(
                                          "Yakin mau hapus vulnerability ini?"
                                        )
                                      ) {
                                        alert(
                                          "Vulnerability " +
                                    ...
                                    <div className="flex items-center gap-3">
                                      <div
                                        className={`w-16 h-16 rounded-full flex items-center justify-center font-bold text-lg ${
                                          vuln.cvssScore >= 9
                                            ? "bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-300 border-2 border-red-300 dark:border-red-500/30"
                                            : vuln.cvssScore >= 7
                                            ? "bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-300 border-2 border-orange-300 dark:border-orange-500/30"
                                            : vuln.cvssScore >= 4
                                            ? "bg-yellow-100 dark:bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 border-2 border-yellow-300 dark:border-yellow-500/30"
