        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden px-8 py-10 md:px-12 md:py-12 scroll-smooth">
          <div className="max-w-7xl mx-auto flex flex-col gap-10 pb-20">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-slate-900 dark:text-slate-100 font-semibold">Targets</span>
            </div>
                  ...
                  <div className="absolute right-0 top-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity duration-300">
                    <span
                      className={`material-symbols-outlined text-7xl ${
                        stat.color === 'primary' ? 'text-blue-500' : stat.color === 'blue' ? 'text-blue-500' : 'text-rose-500'
                      }`}
                    >
                      {stat.icon}
                    </span>
                  </div>
                  <p className="text-slate-600 dark:text-slate-400 text-sm font-semibold uppercase tracking-wider mb-2">{stat.label}</p>
            ...
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-8 flex flex-col gap-6 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2.5 bg-gradient-to-br from-blue-100 dark:from-blue-500/20 to-cyan-100 dark:to-cyan-500/20 rounded-lg">
                  <span className="material-symbols-outlined text-blue-600 dark:text-blue-400 text-xl">add_circle</span>
                </div>
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Add New Target</h3>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-6 border-t border-slate-200 dark:border-slate-700">
                ...
                >
                  <span className={`material-symbols-outlined text-2xl transition-colors ${dragActive ? 'text-blue-600 dark:text-blue-400' : 'text-slate-400'}`}>
                    upload_file
                  </span>
                  <div className="text-left">
                    <p className={`text-sm font-semibold ${dragActive ? 'text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300'}`}>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white">All Targets</h3>
              ...
              <div className="bg-white dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden backdrop-blur-sm">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                      {targets.map((target) => (
                        <tr key={target.id} className="group hover:bg-slate-50 dark:hover:bg-slate-700/20 transition-colors duration-150">
                          <td className="py-4 px-6">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">{target.description}</p>
                              </div>
                            </div>
                          </td>
                          <td className="py-4 px-6">
                            <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold border ${getStatusBadgeColor(target.statusType)}`}>
                          ...
                          <td className="py-4 px-6">
                            {target.statusType === 'scanning' ? (
                              ...
                              <span className="text-sm text-slate-400 dark:text-slate-500 italic">Pending scan...</span>
                            ) : (
                              <div className="flex flex-col gap-1">
                                ...
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">{target.vulnCount}</p>
                              </div>
                            )}
                          </td>
                          <td className="py-4 px-6">
                            <p className="text-sm text-slate-700 dark:text-slate-300 font-medium">{target.lastScanned}</p>
                          </td>
                ...
                <div className="bg-slate-100 dark:bg-slate-700/30 border-t border-slate-200 dark:border-slate-700 px-6 py-4 flex items-center justify-between">
                  <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">Showing 1 to 4 of 124 entries</p>
